...
if (isset($_SESSION["cliente"])) {
	...
	$query = "SELECT * FROM PERSONA WHERE TIPO_PERSONA = 'Cliente' ORDER BY ID_PERSONA";
...
<html lang="es">
	...
	<div>
			<a id="boton2" href="clientecrear.php" target="principal" style='width:100px; height:15px'>Nuevo cliente</a>
	 ...
	 <nav>
		...
		<div id="enlaces">
			...
			<?php }	else { ?>
						...
						<a href="cliente.php?PAG_NUM=<?php echo $pagina; ?>&PAG_TAM=<?php echo $pag_tam; ?>"><?php echo $pagina; ?></a>
		...
		<form method="post" action="muestraCliente.php">
			...
			<div class="fila_cliente">
				...
				<div class="datos_cliente">
					...
					<input id="FECHA_NAC" name="FECHA_NAC"

						type="hidden" value="<?php echo $fila["FECHA_NAC"]; ?>"/>
						...
						<div class="autor"><?php echo "La persona: ". $fila["ID_PERSONA"] . " es " . $fila["NOMBRE"] . " " . $fila["APELLIDOS"]?></div>
						<div class="autor"><?php echo "con dni: ".$fila["DNI"]." nació el: ".$fila["FECHA_NAC"]; ?></div>
